...
for student in students:
    if student['CPSID'] == 10000011:  # Example CPSID to update
        student['FName'] = 'Abigail'
        student['LName'] = 'Almonaci'
...
students[4]['FName'] = 'NewName'  # Updates the first student's first name
students[4]['LName'] = 'NewLastName'
print(students[0])
...
for student in students:
    if student['CPSID'] == 10000011:  # Replace with the condition to find the specific student
        ...
        del student['Email'][0]  # Deletes the first email key-value pair
        print(f"Updated student: {student}")
...
for student in students:
    ...
    if student['CPSID'] == 10000014:
        student['ContactNumber'] = '109-312-7760' 
...
for student in students:
    if student['HR'] == 'B212':  # Condition to find specific students
        student.update({
